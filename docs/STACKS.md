...
This checkout is the **nestjs-typeorm-rabbitmq** stack: NestJS, TypeORM, and RabbitMQ. Compose project name: `ledger-core-nestjs-typeorm-rabbitmq`.
...
- Branch: `stack/nestjs-typeorm-rabbitmq`
- Compose name: `ledger-core-nestjs-typeorm-rabbitmq`
